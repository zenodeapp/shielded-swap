...
read -p "Enter the ibc denomination for naan (ibc/1EAE32...) [default: $IBC_DENOM]: " naan_denom
...
osmosisd tx gamm create-pool --chain-id osmo-test-5 --pool-file ./pool.json --from osmrel --yes
